...
using PySynCS.GUI;
using PySynCS.Translator.Logger;
using PySynCS.Translator.Settings;

namespace PySynCS.Translator {
    public class MessyTranslator : Translator {
        public MessyTranslator(TranslatorSettings tSettings) : base(tSettings) {}

        
        // Returns if to continue
        bool s_ProcessBraces(string trim, string trims, Cache.MessyCompilerCache compiler) {
            ...
            // OTHER, PROB TODO STUFF
                ...
                // 
                // IF (Settings -> RetainEmptyLineWhitespace)
                ...
                if (this._tSet.Syntax.RetainEmptyLineWhitespace) 
        ...
        public override string ToPySyncsFromString(string Code, Logger.Logger logger) {
            var compiler = new Cache.MessyCompilerCache(_tSet);
